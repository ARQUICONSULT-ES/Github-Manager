    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[60] p-4">
      <div className="bg-gray-800 rounded-lg shadow-xl border border-gray-700 max-w-md w-full">
        ...
        <div className="p-6">
          ...
          {confirmationWord && (
            <>
              <p className="font-semibold text-white mb-4 p-3 bg-gray-900 rounded border border-gray-700">
                {confirmationWord}
              </p>
              <input
                type="text"
                ...
                className="w-full px-3 py-2 border border-gray-600 bg-gray-900 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 mb-6"
                disabled={loading}
              />
            </>
          )}
          {!confirmationWord && (
            <div className="mb-6 p-3 bg-yellow-900/20 border border-yellow-800 text-yellow-400 rounded text-sm">
