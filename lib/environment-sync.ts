...
/**
 * Resultado de la sincronización de un tenant
 */
...
/**
 * Resultado de la sincronización de múltiples tenants
 */
 ...
 */
export async function syncTenantEnvironments(tenantId: string, token: string): Promise<SyncResult> {
  try {
...
/**
 * Sincroniza los entornos de múltiples tenants
 */
export async function syncMultipleTenants(
  tenants: Array<{ id: string; customerName?: string }>
